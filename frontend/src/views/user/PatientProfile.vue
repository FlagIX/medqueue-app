...
async function handleSave() {
  ...
  loading.value = true
  try {
    const res = await patientApi.save(form.value)
    if (res.success) { ElMessage.success('添加成功'); dialogVisible.value = false; loadPatients() }
...
<template>
  <div class="page-container">
    <div class="card">
      ...
      <el-dialog v-model="dialogVisible" title="添加就诊人" width="450px">
